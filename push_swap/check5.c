...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/07/16 14:55:42 by ldifino           #+#    #+#             */
/*   Updated: 2023/07/16 14:55:47 by ldifino          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	checker_push2(t_listlink **stack_a, t_listlink *stack_b,
...
void	checker_push(t_listlink *stack_a, t_listlink *stack_b)
{
	...
	tmp = stack_b;
	checker_push2(&stack_a, stack_b, &tmp, &utils);
	if (utils.nodes % 2 != 0)
